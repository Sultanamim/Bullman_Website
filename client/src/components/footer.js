    ...
    <div className=" bg-black py-5 flex flex-col text-white font-mada z-20 ">
      ...
      <div className="flex flex-row nmd:flex-wrap smd:flex-col sm:flex-col xsm:flex-col items-start px-24 mlg:px-10">
        ...
        <div className="flex flex-col  ml-24 nlg:ml-0">
          ...
          <div className="border border-white rounded-[25px] px-5 w-[420px] nsm:w-[230px] py-2 flex flex-row items-center justify-between">
            <input
              placeholder="E-mail"
          ...
          <div className=" flex flex-row items-center mt-10 ">
            <div className="border-[4px] border-white px-[16px] py-3 mx-[2px]  hover:bg-gray-900">
              <i className="fa-brands fa-instagram text-[22px] "></i>
            </div>
            <div className="border-[4px] border-white px-[16px] py-3 mx-[2px] hover:bg-green-500">
